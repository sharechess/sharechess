export const piecesStylesGrouped = {
  hidden: [
    "tagged",
    "anarchy-plug",
    "anarchy-plug_candy",
...
export const hiddenPieces: Set<PiecesStyle> = new Set(["tagged"]);

export const seasonalPieces: Set<PiecesStyle> = new Set([
  "anarchy_halloween",
  "condal_halloween",
]);
