    ...
    <Show when={state.fullscreenPopup === "support"}>
      ...
      >
        <p className="support__intro">
          ...
          beatae at itaque recusandae perspiciatis repudiandae possimus saepe
          deleniti, fuga perferendis, dolorum rerum obcaecati, quos ea debitis
          eveniet qui. Quis, adipisci.
        </p>
        ...
        <div className="support__share">
          <p>Share the project with others, to help it grow!</p>
